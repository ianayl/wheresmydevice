...
public class Status
{
    ...
    public Status(DateTime time, string? publicIP, string? privateIP,
                  string? currentSSID, int? battery, bool? isCharging,
                  List<string>? nearbySSID, (double, double)? location)
    {
        this.timestamp = time;
        ...
        this.nearbySSIDs = (nearbySSID == null) ? new List<string>() : nearbySSID;
    }

    // public static explicit operator StatusResponse(Status s)
    // {
    //     
    // }
